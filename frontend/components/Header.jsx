    ...
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          isScrolled
            ? 'bg-white/95 backdrop-blur-xl shadow-beauty border-b border-beauty-rose/5 py-3'
            : 'bg-transparent py-5'
        }`}
      >
        <nav className="container-beauty flex justify-between items-center">
          ...
          <Link href="/" className="flex items-center gap-2.5 group">
            <div className="w-11 h-11 rounded-full bg-gradient-to-br from-beauty-rose via-beauty-rose-dark to-beauty-gold flex items-center justify-center shadow-beauty group-hover:shadow-beauty-lg transition-all duration-300 group-hover:scale-105 ring-2 ring-white/30">
